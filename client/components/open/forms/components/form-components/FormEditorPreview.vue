<template>
  ...
  >
    ...
    >
      <div class="w-full bg-white dark:bg-gray-950 border-b border-gray-300 dark:border-emerald-900 dark:border-gray-700 rounded-t-lg p-1.5 pl-4 pr-1.5 flex items-center gap-x-1.5">
