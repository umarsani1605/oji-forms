<template>
  <div class="py-8">
    <section>
      <div class="mx-auto max-w-6xl isolate sm:px-6 lg:px-8">
        <div
          class="relative px-4 py-8 overflow-hidden bg-emerald-100 ring-emerald-100 ring-1 sm:shadow-lg isolate sm:rounded-2xl sm:px-16 md:pt-20 lg:flex lg:gap-x-20 lg:px-16 lg:py-0 sm:shadow-gray-600/10"
        >
          ...
          >
            <span
              class="bg-white text-xs font-semibold inline-flex items-center shadow-sm ring-emerald-200 ring-1 text-emerald-600 px-2.5 py-1.5 rounded-full"
            >
              <svg
                aria-hidden="true"
                class="w-4 h-4"
            ...
            >
              ...
              <span
                class="text-transparent bg-clip-text bg-gradient-to-r lg:block from-emerald-600 to-emerald-300"
          ...
          >
            <img
              class="rounded-t-2xl ring-1 ring-emerald-100 lg:rounded-tr-none w-full"
