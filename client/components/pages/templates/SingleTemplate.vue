<template>
  ...
  >
    ...
    >
      <span
        class="inline-flex items-center gap-1 rounded-full bg-emerald-500 px-2 py-1 text-xs font-medium text-white"
      >
        <svg
          aria-hidden="true"
          class="h-3 w-3"
    ...
    <p
      class="text-lg font-semibold leading-tight tracking-tight text-gray-900 mt-4 group-hover:text-emerald-500 transition-all duration-150"
    >
      {{ template.name }}
    </p>
